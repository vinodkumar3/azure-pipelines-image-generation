...
The following software is installed on machines in the Hosted Ubuntu 1804 (v20190925.1) pool
***
- 7-Zip 16.02
...
- Basic CLI:
  ...
  - zip
  - tzdata
- AWS CLI (aws-cli/1.16.245 Python/2.7.15+ Linux/5.0.0-1018-azure botocore/1.12.235)
- build-essential
