...
The following software is installed on machines in the Hosted Ubuntu 1804 (v20191009.1) pool
***
- 7-Zip 16.02
...
- Basic CLI:
  ...
  - zip
  - tzdata
- AWS CLI (aws-cli/1.16.255 Python/2.7.15+ Linux/5.0.0-1018-azure botocore/1.12.245)
- build-essential
...
- Docker (Docker version 3.0.7, build 578ab52e)
- Docker (Docker version 3.0.7, build 578ab52e)
- .NET Core SDK:
  - 2.2.402
  - 2.2.401
  ...
  - 2.1.301
  - 2.1.300
- Erlang (Erlang (SMP,ASYNC_THREADS,HIPE) (BEAM) emulator version 10.5.2)
- Firefox (Mozilla Firefox 69.0.2)
- GNU C++ 7.4.0
- Git (2.23.0)
...
- Heroku (heroku/7.33.2 linux-x64 node-v11.14.0)
- HHVM (HipHop VM 4.26.0 (rel))
- ImageMagick
...
- kubectl (Client Version: v1.16.1)
...
- PHP 7.2 (PHP 7.2.23-1+ubuntu18.04.1+deb.sury.org+1 (cli) (built: Oct  8 2019 05:32:02) ( NTS ))
- PHP 7.3 (PHP 7.3.10-1+ubuntu18.04.1+deb.sury.org+1 (cli) (built: Oct  8 2019 05:33:38) ( NTS ))
...
- Cached container images
  ...
  - node:12 (Digest: sha256:7d459754a062e65f5ad5d738217e00cc71d0cb18adbe055267beaddd0ad4e8b3)
  - node:12-alpine (Digest: sha256:a93cc66176b000e09f7011622c9f2f0faa982fe7e01c961b2506e14b07834175)
