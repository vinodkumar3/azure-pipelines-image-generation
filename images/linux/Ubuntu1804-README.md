...
The following software is installed on machines in the Hosted Ubuntu 1804 (v20191025.1) pool
***
- 7-Zip 16.02
...
- Basic CLI:
  ...
  - zip
  - tzdata
- AWS CLI (aws-cli/1.16.266 Python/2.7.15+ Linux/5.0.0-1022-azure botocore/1.13.2)
- build-essential
...
- Yarn (1.19.1)
- PhantomJS (2.1.1)
- PHP 7.1 (PHP 7.1.32-2+ubuntu18.04.1+deb.sury.org+1 (cli) (built: Oct 24 2019 18:43:48) ( NTS ))
- PHP 7.2 (PHP 7.2.24-1+ubuntu18.04.1+deb.sury.org+1 (cli) (built: Oct 24 2019 18:29:11) ( NTS ))
- PHP 7.3 (PHP 7.3.11-1+ubuntu18.04.1+deb.sury.org+1 (cli) (built: Oct 24 2019 18:23:23) ( NTS ))
